<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TestPage.aspx.cs" Inherits="WebApplication1.TestPage" EnableEventValidation="false"%>
        ...
        <div class="row">
            <div class="col-md-12">
                                ...
                                <asp:GridView ID="GridView1" runat="server" CssClass="footable" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:Button ID="btnJoin" runat="server" Text="Join" CommandName="Join" CommandArgument='<%# Eval("EventId") %>'
                                                    class="btn btn-primary" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:Button ID="btnUsers" runat="server" Text="Scoretable" CommandName="Users" CommandArgument='<%# Eval("EventId") %>'
                                                    class="btn btn-primary" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:Button ID="btnPolls" runat="server" Text="Polls" CommandName="Polls" CommandArgument='<%# Eval("EventId") %>'
                                                    class="btn btn-primary" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:Button ID="btnEdit" runat="server" Text="Edit"  CommandArgument='<%# Eval("EventId") %>'
                                                    class="btn btn-primary" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            <asp:Button ID="btnAdd" runat="server" Text="Add New Event" class="btn btn-success" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div align="center" class="modal-footer">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <asp:Button ID="btnSave" runat="server" Text="ADD"  class="btn btn-success"
        ...
        <div align="right" class="modal-footer">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:Button ID="btnYes" runat="server" Text="Yes"  class="btn btn-danger">
                    </asp:Button>
